# MockBOT Project - iRobot© Create 1/Roomba 400 Base

This project defines the Jazzy branch for the Roomba 400/Create 1 base only.  
...
mockbotc1\_bringup bringup.launch.py**. This script launches the Create\_1/ Roomba 400 Base, RPLidar, ekf\_filter, robot_description, joy\_teleop. The other launch scripts in the launch folder such as for the Camera Oak-D Lite are in development.

Launching the Robot Description, Mapping and Locaization, Navigation functions are executed in the Desktop.
...
Another required deveopment task was to design a powering configuration due to the new "Power Delivery" function of the Raspberry Pi 5. With typical choices of a 1) "Power Bank" or 2) Lipo Battery/Buck DC-DC Converor, I selected 2). More detail is included in the MockBOT Book and a "Powering Raspberry Pi 5" read.me.